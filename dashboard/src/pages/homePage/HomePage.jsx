    ...
    <div>
      ...
      <div className="flex p-10 ">
        <div className="w-1/4 p-10">
          <div className="flex justify-center items-center text-[#0B3B72] rounded-full bg-[#edf2ee] h-[80px] w-[80px]">
            <i className="fa fa-truck-fast text-[30px]"></i>
          </div>
          <h1 className="text-[18px] font-bold">Free Shipping</h1>
          <p className="text-sm text-[#aaadaa]">Free shipping with discount</p>
        </div>
        <div className="w-1/4 p-10">
          <div className="flex justify-center items-center text-[#0B3B72] rounded-full bg-[#edf2ee] h-[80px] w-[80px]">
            <i className="fa-solid fa-headset text-[30px]"></i>
          </div>
          <h1 className="text-[18px] font-bold">Great Support 24/7</h1>
          <p className="text-sm text-[#aaadaa]">Instant access to Contact</p>
        </div>
        <div className="w-1/4 p-10">
          <div className="flex justify-center items-center text-[#0B3B72] rounded-full bg-[#edf2ee] h-[80px] w-[80px]">
            <i className="fa fa-shopping-cart text-[30px]"></i>
          </div>
          <h1 className="text-[18px] font-bold">100% Secure Payment</h1>
          <p className="text-sm text-[#aaadaa]">We ensure your money is save</p>
        </div>
        <div className="w-1/4 p-10">
          <div className="flex justify-center items-center text-[#0B3B72] rounded-full bg-[#edf2ee] h-[80px] w-[80px]">
            <i className="fa fa-box text-[30px]"></i>
          </div>
          <h1 className="text-[18px] font-bold">Money-Back Guarantee</h1>
          <p className="text-sm text-[#aaadaa]">30 days money back</p>
        </div>
      </div>

      {/* Popular Products */}
      <div className="bg-[#edf2ee] p-10 ">
        <div className="flex justify-between items-center ">
          <div className="flex justify-normal items-center">
            <h1 className="text-[32px] font-bold ">Popular Products</h1> &#160;
            &#160;
            <div className="flex">
              <div className="">
                <span className="rounded-full text-white p-2  text-sm font-semibold bg-[#ff455b]">
                  08
                </span>
                &#160; &#58; &#160;
              </div>
